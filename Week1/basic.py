...
for idx, example in enumerate(dataset):
    ...
    save_image(original, f"result/{idx}_original.png")
    save_image(resized, f"result/{idx}_resize.png")
    save_image(grayscaled_tensor, f"result/{idx}_grayscale.png")
    save_image(blurred, f"result/{idx}_blur.png")
    save_image(augmented, f"result/{idx}_augment.png")
